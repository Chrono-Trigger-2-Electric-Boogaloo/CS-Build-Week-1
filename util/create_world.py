...
forest_movements=[[15, 15, 15, 15, 15, 15, 15, 15, 15, 15], [15, 15, 15, 15, 15, 15, 15, 15, 15, 15], [8,13,13,13,9,15,15,15,15,15],[10,14,14,14,11,15,2,15,15,15],[14,14,14,14,14,13,11,15,15,15],[10,14,14,12,14,14,14,13,13,9],[10,14,6,15,10,14,14,14,14,11],[10,11,15,15,7,12,14,14,12,6],[10,11,13,9,15,15,10,11,15,15],[7,12,12,6,15,15,7,12,3,15]]

dungeon_movements=[[15,15,15,15,15,15,15,15,15,15],[15,15,15,15,1,9,8,13,13,9],[15,15,15,15,15,4,10,14,14,11],[15,15,15,15,15,4,10,14,12,6],[15,2,15,8,13,14,14,11,15,15],[15,7,13,14,14,14,14,11,15,15],[15,15,7,14,14,14,14,14,13,9],[15,15,15,7,12,12,14,14,14,11],[15,2,15,15,15,15,10,14,14,11],[15,7,5,5,5,5,12,12,12,6]]

house_movements=[[15,15,15,15,15,15,15,15,15,15],[16,1,13,13,9,15,8,13,13,9],[15,15,10,14,11,15,10,12,12,6],[8,13,14,14,14,13,11,15,4,15],[14,14,14,14,14,14,11,15,4,15],[10,14,14,14,14,14,14,13,14,9],[10,14,14,14,12,12,14,14,14,11],[10,14,14,11,15,15,10,14,14,11],[10,14,14,14,13,13,14,14,14,11],[7,12,12,12,12,12,12,12,12,6]]

basement_movements=[[15,15,8,13,13,13,9,15,15,15],[15,15,10,14,12,12,12,13,9,15],[15,15,10,11,15,15,15,10,14,3],[8,13,14,11,15,2,15,10,14,11],[10,14,14,11,15,4,15,10,14,11],[10,14,14,11,15,4,15,10,14,11],[10,14,14,14,13,14,13,14,14,11],[7,12,14,14,14,14,14,14,14,6],[15,15,7,14,14,14,14,12,6,15],[15,15,15,7,12,12,6,15,15,15]]
...
forest_objects[4][0].connectRooms(forest_objects[9][8], "w")

# forest_objects[3][0].connectRooms(forest_objects[9][8], "s")

# forest_objects[5][0].connectRooms(forest_objects[9][8], "n")

# field[2][3]
# forest_objects[9][7].connectRooms(forest_objects[4][1], "e")

forest_objects[9][8].connectRooms(dungeon_objects[1][7], "e")
dungeon_objects[1][7].connectRooms(forest_objects[9][8], "n")




# dungeon_objects[2][7].connectRooms(ryan_room_objects[4][0], "n")
# ryan_room_objects[4][0].connectRooms(dungeon_objects[2][7], "w")
ryan_room_objects[4][0].connectRooms(forest_objects[2][3], "w")
forest_objects[2][3].connectRooms(ryan_room_objects[4][0], "n")


ryan_room_objects[1][1].connectRooms(boss_room_objects[9][6], "w")

boss_room_objects[9][3].connectRooms(ryan_room_objects[1][1], "s")
boss_room_objects[9][4].connectRooms(ryan_room_objects[1][1], "s")
boss_room_objects[9][5].connectRooms(ryan_room_objects[1][1], "s")
boss_room_objects[9][6].connectRooms(ryan_room_objects[1][1], "s")

players=Player.objects.all()
for p in players:
  p.currentRoom=ryan_room_objects[1][4].id
  p.save()